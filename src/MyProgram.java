        ...
        for (int i = 0; i < a.length; i++) {
            for (int j = 0; j < a[i].length; j++) {
                for (int k = 0; k < a[i][j].length; k++) {
                    ...
                    a[i][j][k] = 10 + (int) (Math.random() * (100 - 10 + 1));
                }
            }
        }
    }
...
//        InputMass(b);
        ...
        int n = in.nextInt();
        int[][][] point3d = new int[n][n][n];

       /* for (int i = 0; i < point3d.length; i++) {
            for (int j = 0; j < point3d[i].length; j++) {
                for (int k = 0; k < point3d[i][j].length; k++) {

                    point3d[i][j][k] = (int)(Math.random() * 10);
